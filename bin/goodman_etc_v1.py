...
# ============================================================
def plot_spectrum(spectrum, wave_eff, grism, obsmode, disp, spec_type, 
        metallicity, vmag, seeing, exptime, slit, title, src):
    ...
    obsmode = obsmode.lower()
    plotname = f"plot_{src}_{spec_type}_{vmag}mag_{grism}{obsmode}.png"
    plt.savefig(exec_dir + '/' + plotname, dpi=300)
    #plt.tight_layout()
    #plt.show()
...
def steer(argv):
    ...
    sky_model = get_sky_model(moon_phase)
    ...
    src = "source"
    #print(source_spec)
    plot_spectrum(source_spec, wave_eff, grism, obsmode, disp, spec_type, 
        metallicity, vmag, seeing, exptime, slit, title, src)

    noise_spec = make_noise_spectrum(source_spec, sky_model, eff_file, rdnoise, disp, exptime, sa, pix_scale, bin_dispersion, bin_spatial, seeing)

    #print(noise_spec)
    title = "Noise Spectrum"
    src = "noise"
    #plot_spectrum(noise_spec, wave_eff, grism, obsmode, disp, spec_type, 
    #    metallicity, vmag, seeing, exptime, slit, title, src)
    ...
    title = "S/N Spectrum"
    src = "sn"
    plot_spectrum(s2n, wave_eff, grism, obsmode, disp, spec_type, 
        metallicity, vmag, seeing, exptime, slit, title, src)
